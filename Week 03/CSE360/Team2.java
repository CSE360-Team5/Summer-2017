...
public class Team2 extends JPanel implements ActionListener {
    ...
    public void init() {
        try {
            ...
            Weather.add(city);
            layout.putConstraint(SpringLayout.EAST, city, 0, SpringLayout.EAST, Weather);
            layout.putConstraint(SpringLayout.NORTH, city, 0, SpringLayout.SOUTH, l_dew);
