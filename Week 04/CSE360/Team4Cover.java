...
ActionListener buttonListener = new ActionListener(){
    ...
    private JPanel mapPlate(String coords){
        ...
        //Creates and adds a LayeredPane to the Map Panel, and sets mapImage.jpg as the lower pane, and the Ghost PNG, and the Team4Ghost Runnable as the higher Pane
        //Author Sean Casaus-------------------------------------------------------------------------------------------------------------------------------------------
        layeredPane = new JLayeredPane();
    	layeredPane.setPreferredSize(new Dimension(90,90));
    	mapPanel.add(layeredPane, BorderLayout.CENTER);
    	
        JLabel myGraphic = new JLabel(new ImageIcon((new ImageIcon("mapImage.jpg")).getImage().getScaledInstance(90,90,java.awt.Image.SCALE_SMOOTH)));
        ...
        JLabel myImage = new JLabel(new ImageIcon("Pac-Man-Ghost-PNG-Transparent-Image.png"));
    	layeredPane.add(myImage, JLayeredPane.PALETTE_LAYER);
        layeredPane.add(ghost, JLayeredPane.PALETTE_LAYER);
        
    	mapPanel.setBounds(1,1,90,90);
